...
// get data array from local .json file
...
class Cities extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      value: '',
      apiURL:
        'http://api.openweathermap.org/data/2.5/forecast?id=519188&APPID=9e3b41b556d2b7085e43777a1f5d5923'
    };
    ...
    this.setState(
      {
        ...
        apiURL:
          ...
          value +
          '&APPID=8f3bce6554087613da59a6627c23c861'
      }
